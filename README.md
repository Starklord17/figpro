...
A minimalistic Figma clone showcasing real-world features like live collaboration with cursor chat, comments, reactions, and the capability to draw designs including shapes and image uploads directly on the canvas using fabric.js.
